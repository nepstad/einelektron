...
void Export_wrapper()
{
    class_< CustomPotential_AngularKineticEnergy_Spherical<2>, boost::noncopyable, CustomPotential_AngularKineticEnergy_Spherical_2_Wrapper >("CustomPotential_AngularKineticEnergy_Spherical_2", init<  >())
    ...
    class_< SphericalKineticEnergyEvaluator<2>, boost::noncopyable, SphericalKineticEnergyEvaluator_2_Wrapper >("SphericalKineticEnergyEvaluator_2", init<  >())
    ...
    class_< CustomPotential_LaserLength_Z<2>, boost::noncopyable, CustomPotential_LaserLength_Z_2_Wrapper >("CustomPotential_LaserLength_Z_2", init<  >())
    ...
    class_< CustomPotential_LaserLength_X<2>, boost::noncopyable, CustomPotential_LaserLength_X_2_Wrapper >("CustomPotential_LaserLength_X_2", init<  >())
    ...
    class_< CustomPotential_LaserLength_Y<2>, boost::noncopyable, CustomPotential_LaserLength_Y_2_Wrapper >("CustomPotential_LaserLength_Y_2", init<  >())
    ...
    class_< DynamicPotentialEvaluator<CoulombPotential<2>,2>, boost::noncopyable >("CoulombPotential_2", init<  >())
    ...
    class_< DynamicPotentialEvaluator<SingleActiveElectronPotential<2>,2>, boost::noncopyable >("SingleActiveElectronPotential_2", init<  >())
    ...
    class_< DynamicPotentialEvaluator<OverlapPotential<2>,2>, boost::noncopyable >("OverlapPotential_2", init<  >())
    ...
    class_< DynamicPotentialEvaluator<ComplexAbsorbingPotential<2>,2>, boost::noncopyable >("ComplexAbsorbingPotential_2", init<  >())
    ...
    class_< ComplexAbsorbingPotential<2>, boost::noncopyable >("ComplexAbsorbingPotential_custom_2", no_init)
